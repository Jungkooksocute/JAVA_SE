...
//phone标准类的构建
    ...
    public void call(){
        System.out.println("正在使用价格为"+price+"元"+color+"色的"+brand+
                "手机打电话");
    }
    public void message(){
        System.out.println("正在使用价格为"+price+"元"+color+"色的"+brand+
...
//
    ...
    public void show(){
        System.out.println("我女朋友叫"+name+";身高："+height+
                "厘米，体重："+weight+"斤");
    }
    public void cook(){
...
public class Text {
    public static void main(String[] args) {
        Girlfriend a=new Girlfriend("凤姐",155,130
        );
        a.show();
        a.wash();
        a.cook();
...
public class Coder {
    ...
    public void work(){
        System.out.println("工号为"+id+"基本工资为"+salary+
                "的程序员"+name+"正在努力的写着代码.......");
    }
}
...
public class Text {
    public static void main(String[] args) {
       Manager a=new Manager("张三","123",15000,6000);
       Coder b=new Coder("李四","135",10000);
       a.work();
       b.work();
    }
}
